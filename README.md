...
Human-hand video understanding, XHand retargeting, contact-aware occlusion,
object reconstruction, inpainting, and robot-policy experiments.
...
```bash
git clone --recurse-submodules https://github.com/sh-min/Human2Robot.git
```
