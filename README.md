...
The replacement pipeline is locked to a complete RB5-850e arm with XHand.
Human hand/arm pixels are removed first, then the fixed-base robot render and
interaction-object layers are composited. No alternate robot embodiment or
partial-arm render mode is supported.
