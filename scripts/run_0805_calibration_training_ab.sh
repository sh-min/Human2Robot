...
CALIBRATED_DATA="${CALIBRATED_DATA:-$ROOT/data/cube_dataset/26.08.05_stereo_calibrated}"
APPROX_DATA="${APPROX_DATA:-$ROOT/data/cube_dataset/26.08.05_stereo_approx}"
ACTION_LABELS="${VJEPA_ACTION_LABELS:-HangCup,StackContainers,PlaceLightGreenSnackBoxInTrashBin,PlaceRedSnackBoxInTrashBin,WipeFloorWithSponge,Transition}"
