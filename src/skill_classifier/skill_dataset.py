...
HAND_REPRESENTATIONS = ("axis_angle", "rot6d")
...
class SkillWindowDataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            hand_representation: ``axis_angle`` (legacy) or continuous ``rot6d``
        """
        ...
        for rec in recordings:
            ...
            if vjepa_key is None:
                ...
                vjepa = rec[vjepa_key]
                if vjepa.ndim != 2 or len(vjepa) != T:
                    raise ValueError(
