...
class AnnotationSemanticsTests(unittest.TestCase):
    ...
    def test_legacy_milk_profile_remains_available(self):
        profile = LABEL_PROFILES["kitchen_milk"]
        self.assertIn("Milk", profile["labels"])
        self.assertNotIn("Choco", profile["labels"])
